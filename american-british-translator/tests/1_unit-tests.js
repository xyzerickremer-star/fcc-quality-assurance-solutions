...
suite('Unit Tests', () => {
  ...
  test('Translate I met the carer at the cashpoint. to American English', () => {
    assert.equal(translator.translate('I met the carer at the cashpoint.', 'british-to-american', false), 'I met the caregiver at the ATM.');
  });
  ...
  test('Translate Tea time is usually around 4.30. to American English', () => {
    assert.equal(translator.translate('Tea time is usually around 4.30.', 'british-to-american', false), 'Tea time is usually around 4:30.');
  });
  ...
  test('Highlight translation in Tea time is usually around 4.30.', () => {
    assert.equal(translator.translate('Tea time is usually around 4.30.', 'british-to-american'), 'Tea time is usually around <span class="highlight">4:30</span>.');
  });
});
